...
import { Check, Search } from "@/core-ui/public/icons";
import type { Triggers } from "@/core-ui/types";
...
export const CFormSelect = forwardRef<HTMLInputElement, CFormSelectProps>(
  (
    { isSearch, onGetValue, options, error, trigger = "click", ...rest },
    refs
  ) => {
    ...
    const handleSelection = (selectedIndex: number) => {
      ...
      setListData(options || []);
      setSearch("");
      setSelect(selectedItem as Option);
      if (onGetValue) onGetValue(selectedItem as Option);
    };
