...
import { prefix } from "../public/data";
import { ArrowSmall, Check, Search } from "../public/icons";
...
export const PhoneNumber = forwardRef(function Phone(
  {
    trigger = "click",
    onGetPrefix,
    error,
  ...
  const handleSelection = (selectedIndex: number) => {
    ...
    setVisible(false);
    setListData(prefix);
    setSelect(selectedItem as OptionNumber);
  };
  ...
  return (
    <Manager>
      ...
      >
        {label && (
          <div className="mb-2">
            <p className="inline-block text-base font-normal leading-6 text-ic-ink-6">
              {label}
            </p>
        ...
        {error && (
          <p className="mx-4 mt-1 text-red-6 text-sm font-normal leading-5">
            {error}
          </p>
        )}
        {visible && (
